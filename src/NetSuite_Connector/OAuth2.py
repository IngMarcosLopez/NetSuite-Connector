...
class NetSuiteOAuth2:
    ...
    def _create_jwt_assertion(self) -> str:
        ...
        payload = {
            ...
            "aud": f"https://system.netsuite.com/app/login/oauth2/token.nl",
            "iat": now,
    ...
    def get_access_token(self) -> Optional[str]:
        ...
        try:
            ...
            # Token endpoint
            token_url = f"https://system.netsuite.com/app/login/oauth2/token.nl"
    ...
    def make_authenticated_request(
        ...
        if not token:
            response = NetsuiteObject(url=url, request_headers=headers, request_data=data)
            response.code = 401
        ...
        response = NetsuiteObject(url=url, request_headers=headers, request_data=data or json_data)
